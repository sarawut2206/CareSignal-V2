...
| F-02 | Falls history — บันทึกย้อนหลัง 12 เดือน | PASS | CareSignal-App.html:2034 · CareSignal-Vision.html:525 · supabase/07_closed_loop.sql:17 |
| F-03 | Medication risk — OCR + ผู้ใช้ยืนยัน + ส่งเภสัชกร | PASS | CareSignal-App.html:4029 · CareSignal-Vision.html:4473 · CareSignal-App.html:4327 |
...
| F-07 | Case workflow — สถานะเปลี่ยนตามลำดับที่กำหนด | PASS | CareSignal-Staff.html:1155 · supabase/09_insurtech.sql:20 |
...
| F-11 | Insurer dashboard — aggregate / de-identified เท่านั้น | PASS | supabase/08_outcomes.sql:16 · supabase/11_dashboards.sql:206 · supabase/21_insurer_trend.sql:4 |
...
| W-11 | ปิดเคสต้องผ่านคน ไม่มีทางปิดอัตโนมัติ | PASS | จุดที่เปลี่ยนเป็น stable/closed: cs-backend.js:618 · RLS cases_staff: true |
...
| X-20 | บัญชีบริษัทประกันถูกซ่อนเมนูรายบุคคลตั้งแต่แรก ไม่ใช่กันตอนกด | PASS | เมนูบริษัทประกัน: "port","prev","me" |
...
| X-92 | จำนวนตัวยาที่แจ้งผู้ใช้ตรงกับฐานจริง | PASS | ฐาน 362 ตัวยา ตรงกันทุกหน้า |
...
| X-141 | ข้อความที่ผู้ใช้เห็นบอกบทบาทเป็น คัดกรอง · เฝ้าระวัง · ส่งต่อ ไม่อ้างว่าระบบป้องกันการล้มเอง | PASS | ไม่มี บริการ/แผน/โปรแกรมป้องกัน หรือ ป้องกันก่อนเคลม ในหน้าเว็บ แอป คอนโซล แดชบอร์ด และโมดูลใช้ร่วม |
| X-140 | แจ้งเหตุ: เปิดเคสตามความรุนแรง · บริษัทประกันเห็นแค่ภาพรวมไม่ระบุตัวตน ไม่ใช่ข้อมูลเคลม | PASS | insurer_incident_summary คืนเฉพาะจำนวน · ผู้ยินยอม share_pool · ตรวจบทบาท · กลุ่มเล็กแสดง <3 · คอนโซลเห็นรายละเอียด |
| X-139 | นัดตรวจทางวิดีโอ: ผู้เชี่ยวชาญลงชื่อยืนยันผลแก้ไขไม่ได้ · บริษัทประกันได้เฉพาะคำขอไม่ระบุชื่อที่ยืนยันแล้วและครอบครัวยินยอม · ไม่บันทึกภาพ | PASS | insurer_prevention_list ไม่มีคอลัมน์ระบุตัวตน · ส่งได้เมื่อ risk=confirmed และ share_insurer · ผู้ตรวจลงชื่อเอง attested แก้ไม่ได้ · รหัสห้องไม่เปิดอ่ |
| X-138 | รายชื่อโทรติดตามรายคน: เฉพาะผู้ประสานงาน โทรออกได้ บันทึกผลลงประวัติเคส ไม่รับสาย 3 ครั้ง = ขาดการติดตาม | PASS | staff_call_list/staff_followup_result ตรวจสิทธิ์ที่ฐานข้อมูล · ลง contact_log + audit_logs · เมนูเฉพาะ care_manager/admin · ปุ่ม tel: · ครบ 3 ครั้งเป็ |
| X-137 | ผู้เชี่ยวชาญเห็นเคสได้เฉพาะเมื่อใบอนุญาตผ่านการตรวจโดยผู้ดูแลระบบและยังไม่หมดอายุ บังคับที่ฐานข้อมูล | PASS | cs_credential_ok ครอบฟังก์ชันสิทธิ์ 5 ตัวและนโยบาย 3 ตัว · แก้ข้อมูลกลับไปรอตรวจ · อนุมัติได้เฉพาะผู้ดูแลระบบและไม่ใช่ของตัวเอง · รูปอยู่บัคเก็ตส่วนตั |
