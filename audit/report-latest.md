...
| F-02 | Falls history — บันทึกย้อนหลัง 12 เดือน | PASS | CareSignal-App.html:1566 · CareSignal-Vision.html:531 · supabase/07_closed_loop.sql:17 |
| F-03 | Medication risk — OCR + ผู้ใช้ยืนยัน + ส่งเภสัชกร | PASS | CareSignal-App.html:3444 · CareSignal-Vision.html:4203 · CareSignal-App.html:3742 |
| F-04 | FTSST / TUG — มี safety gate ก่อนทดสอบ และบันทึกผล | PASS | CareSignal-App.html:1542 · CareSignal-Vision.html:507 · supabase/01_schema.sql:79 |
| F-05 | Barthel ADL — คำนวณและแสดงแนวโน้ม | PASS | CareSignal-App.html:4000 · CareSignal-Vision.html:4077 · CareSignal-App.html:2626 |
| F-06 | Risk engine — Green/Yellow/Red ตามกฎที่ประกาศ | PASS | CareSignal-App.html:1835 · CareSignal-Vision.html:783 · CareSignal-App.html:1630 |
...
| X-85 | ผู้ช่วยเสียงตอบคำถามได้ ไม่ใช่รับเฉพาะคำสั่งตายตัว | PASS | ครบทั้งแอปสมาชิกและหน้าทดลอง |
| X-86 | ตัดคำลงท้ายก่อนจับคำสั่ง (พูดสุภาพแล้วยังสั่งได้) | PASS | ครบทั้งแอปสมาชิกและหน้าทดลอง |
| X-87 | ฟังไม่เข้าใจต้องบอกว่าพูดอะไรได้ ไม่เงียบ | PASS | ครบทั้งแอปสมาชิกและหน้าทดลอง |
| X-88 | คำตอบด้วยเสียงเขียนไว้ล่วงหน้า ไม่เรียกโมเดลภาษาภายนอก | PASS | ครบทั้งแอปสมาชิกและหน้าทดลอง |
| X-89 | คำตอบด้วยเสียงต้องไม่ข้ามเส้นเป็นการวินิจฉัยหรือแนะนำยา | PASS | ครบทั้งแอปสมาชิกและหน้าทดลอง |
...
| X-104 | ด่านกันระบบพูดใส่ตัวเอง ต่อไว้หน้า vcDispatch และไม่ปิดหูนานเกินไป | PASS | ครบทั้งสองแอป และเรียกก่อนตัดสินใจ |
| X-105 | ปุ่มติดตั้งเป็นแอปในหน้าแรกกดได้จริงทุกเบราว์เซอร์ | PASS | เป็นปุ่มจริง มีตัวรับการกด และมีคำแนะนำครบทุกแพลตฟอร์ม |
| X-106 | สั่งงานด้วยเสียงแบบทีละขั้น พูดแล้วทำทันที ไม่ต้องยืนยันซ้ำ | PASS | ครบทั้งสองแอป ทุกหน้าวัดผลประกาศขั้นตอน และลำดับการจับคำถูกต้อง |
...
| X-110 | การตรวจเดินหน้าได้ด้วยกล้อง แม้คำสั่งเสียงใช้ไม่ได้เลย | PASS | ทั้งสี่หน้าวัดผลนับถอยหลังเอง ยกเลิกได้ด้วยเสียง ปุ่ม และแตะจอ |
