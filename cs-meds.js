/* ============================================================
   ...
   ไฟล์นี้ไม่ใช่ฐานข้อมูลยาที่ครบถ้วน — เป็นรายการยาที่พบบ่อยใน
   ผู้สูงอายุไทยและเกี่ยวข้องกับความเสี่ยงหกล้ม ราว 160 รายการ
   ยาที่ไม่พบในนี้จะถูกบันทึกเป็น "ไม่ทราบกลุ่ม" แล้วส่งเภสัชกรดู
   ============================================================ */
var CSMeds = (function () {
