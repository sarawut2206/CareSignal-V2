/* ============================================================
   ...
   Methodology · การเชื่อมกับ Thai Medicines Terminology (TMT) ของ
   ศูนย์ข้อมูลยาแห่งชาติเป็นขั้นถัดไป — โครงสร้างในนี้ออกแบบให้
   ใส่ tmt_id ต่อรายการได้โดยไม่ต้องรื้อ

   ขอบเขตและแผนขั้นถัดไป (ประกาศไว้ให้ชัด ไม่อ้างเกินจริง)
   ------------------------------------------------------------
   ไฟล์นี้ไม่ใช่ทะเบียนยาทั้งประเทศ — เป็นตัวยาสำคัญ 155 รายการที่พบบ่อย
   ในผู้สูงอายุไทยและเกี่ยวข้องกับความเสี่ยงหกล้ม
   ยาที่ไม่พบในนี้จะถูกบันทึกเป็น "ไม่ทราบกลุ่ม" แล้วส่งเภสัชกรจัดกลุ่ม
   — ระบบไม่เดาและไม่ข้ามเงียบ ๆ

   ขั้นถัดไปคือเชื่อมกับ Thai Medicines Terminology (TMT) ของศูนย์ข้อมูล
   ยาแห่งชาติ และ/หรือฐานทะเบียนยาของ อย. ซึ่งต้องขอสิทธิ์เข้าถึงในนาม
   โครงการก่อน โครงสร้าง BY_INN ออกแบบให้เพิ่มฟิลด์ tmt_id ต่อรายการได้
   ทันทีโดยไม่ต้องแก้ตัวจับคู่หรือชั้นจัดกลุ่ม FRID

   เหตุผลที่ยังไม่เชื่อมแล้วก็ยังใช้งานได้: การจับคู่ผิดจากฐานข้อมูลใหญ่
   อันตรายกว่าการไม่รู้จักยา เพราะยาที่จับคู่ผิดจะได้กลุ่ม FRID ผิดตามไปด้วย
   แล้วกลายเป็นสัญญาณเสี่ยงที่ผิด ส่วนยาที่ไม่รู้จักจะไปถึงเภสัชกรเสมอ
   ============================================================ */
var CSMeds = (function () {
