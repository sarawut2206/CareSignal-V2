...
python tools/make-mission3-summary.py
  ...
  → validation/ภาคผนวก-ข้อมูลผู้ให้ข้อมูล-ภารกิจ3-ส่งOIC.docx และ .pdf   (1 หน้า)
...
def build_summary():
    ...
    h2(doc, f"1. กลุ่มเป้าหมายและจำนวนผู้ให้ข้อมูล · รวม {ELDERS_N + nf} คน")
    ...
    h2(doc, "2. ปัญหาที่ทีมกำลังแก้ เป็นปัญหาที่ผู้ใช้พบจริงหรือไม่ — พบจริงทั้งสองกลุ่ม")
    ...
    h2(doc, "3. Solution ที่นำเสนอช่วยแก้ปัญหาได้หรือไม่ — เห็นประโยชน์ แต่ต้องสื่อสารให้ชัดขึ้น")
    ...
    h2(doc, "4. Feature ใดที่ผู้ใช้ต้องการหรือมองว่ามีประโยชน์มากที่สุด")
    rows = []
